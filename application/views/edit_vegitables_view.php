            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-4">
                            <?php echo form_open('vegitables/edit'); ?>
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <strong>Edit vegitable</strong>
                                </div>
                                <div class="panel-body">
                                    <div class="form-group">
                                        <label>Vegitable Name</label>
                                            <input class="form-control" name="vegitablename" type="text" value="<?php if(isset($vegdata)){echo $vegdata;} ?>">
                                    ...
                                    <div class="form-group">
                                            <div class="checkbox">
                                                <label>
                                                    ...
                                                    ?>
                                                    <input type="checkbox" name="statuscheck" value="1" <?php  echo(checkboxstatus($checkstat)); ?>>Make this vegitable enable.
                                                </label>
                                            </div>
